...
- [Paper List for In-context Learning](#paper-list-for-in-context-learning)
  ...
  - [Papers](#papers)
    - [Survey](#survey)
    - [Model Training for ICL](#model-training-for-icl)
...
If you recommend related works on ICL or make contributions on this repo (https://github.com/dqxiu/ICL_PaperList), please provide your information (name, homepage) and we will add you to the contributor list😊. 
